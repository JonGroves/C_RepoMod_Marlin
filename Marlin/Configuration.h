 ...
 */
#define TEMP_SENSOR_0 1 //Must be >0 or an error occurs
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY 450 //Can go up to 500 reliably for my CNC machine.  Max 600.
#define HOMING_FEEDRATE_Z  450 //Can go up to 450 reliably for my CNC machine.  Max 500.
